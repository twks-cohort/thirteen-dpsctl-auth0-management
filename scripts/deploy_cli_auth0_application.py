...
client_id_result = os.system(f"op item edit team-thirteen-svc-auth0 --vault cohorts {os.environ.get('TENANT')}-{os.environ.get('TENANT_APPLICATION')}-client-id[text]={response.json()['client_id']}")
